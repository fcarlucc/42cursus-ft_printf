...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/21 19:33:27 by fcarlucc          #+#    #+#             */
/*   Updated: 2023/05/21 19:33:31 by fcarlucc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	manage_flag_space(va_list param, const char *str_format, t_flag *flag)
{
	...
	if (str_format[flag->index] == 'c')
		return (flag_space_c(va_arg(param, int), flag));
	else if (str_format[flag->index] == 's')
		return (flag_space_s(va_arg(param, char *), flag));
	else if (str_format[flag->index] == 'd' || str_format[flag->index] == 'i')
		return (flag_space_d(va_arg(param, int), flag));
	else if (str_format[flag->index] == 'u')
		return (flag_space_u(va_arg(param, unsigned int), flag));
	else if (str_format[flag->index] == 'p')
		return (flag_space_p(va_arg(param, unsigned long), flag));
	else if (str_format[flag->index] == 'x')
		return (flag_space_x(va_arg(param, unsigned int), flag));
	else if (str_format[flag->index] == 'X')
		return (flag_space_xx(va_arg(param, unsigned int), flag));
	return (1);
}
